...
app.get("/game/:gameName", function(req, res) {
    ...
    res.render("game-room", {gameRoom: gameRoom});
})
...
app.post("/create_game", function(req, res) {
    ...
    let gameRoom = new GameRoom(gameName, new TicTacToeGame());
...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
// tic-tac-toe specific logic below here. Will need to move to a separate module.
...
TicTacToeGame.prototype.toClientJSON = function() {
    return {
        board: this.board,
...
TicTacToeGame.prototype.getPlayers = function() {
    return [this.player1, this.player2];
}

TicTacToeGame.prototype.getPlayer = function(playerName) {
...
TicTacToeGame.prototype.move = function(playerName, move) {
...
TicTacToeGame.prototype.checkState = function() {
...
TicTacToeGame.prototype.setWinner = function(marker) {
    this.hasWinner = true;
    this.gameOver = true;
